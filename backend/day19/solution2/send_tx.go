...
func main() {
	...
	noncePool = NewNoncePool(int64(nonce))
...
func sendUniTokenTransferTx(client *ethclient.Client, address common.Address, privateKey *ecdsa.PrivateKey) (tx *types.Transaction, nonce int64, err error) {
